...
const cols = [
  ...
  { title: "Solutions", links: [["Problems we solve", "/solutions#problems"], ["Cost calculator", "/solutions#calculator"], ["Industries", "/solutions#industries"]] },
  { title: "Company", links: [["About Zyntraz", "/company"], ["Services", "/services"], ["How we work", "/services#process"], ["FAQ", "/contact#faq"]] },
];
      ...
      <footer className="gfoot">
        <div className="container">
          ...
          <div className="gfoot-bottom">
            <Image src="/zyntraz-logo.png" alt="Zyntraz" width={894} height={174} className="gfoot-logo" />
            <span>Copyright © {new Date().getFullYear()} Zyntraz. All rights reserved.</span>
            <span className="gfoot-tag">Intelligence, engineered.</span>
          </div>
        </div>
      </footer>
